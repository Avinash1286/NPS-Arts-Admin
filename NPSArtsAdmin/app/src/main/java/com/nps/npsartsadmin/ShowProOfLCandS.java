...
public class ShowProOfLCandS extends AppCompatActivity {
  ...
  private   TextView setProfileTitle;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_pro_of_lcand_s);
        currentUserIdss = getIntent().getExtras().get("userId").toString();
        Typeface roboto=Typeface.createFromAsset(getAssets(),"font/AvenyTMedium.otf");
        showProPic = (CircularImageView) findViewById(R.id.otheruserProfilePicInLikes);
        showNoOfPost = (TextView) findViewById(R.id.othercontainNumberOfPostInLike);
        Window window=getWindow();
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            window.setStatusBarColor(getResources().getColor(R.color.primaryStatus));
        }
        showName = (TextView) findViewById(R.id.otherusernameInLike);
        setToolbarInAllProfile=(Toolbar)findViewById(R.id.otherprofileActivityToolInLike);
        setSupportActionBar(setToolbarInAllProfile);
        ActionBar actionBar=getSupportActionBar();
        LayoutInflater layoutInflater=(LayoutInflater)this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        View view=layoutInflater.inflate(R.layout.layout_for_lcs,null);
        actionBar.setDisplayShowCustomEnabled(true);
        actionBar.setCustomView(view);
        setProfileTitle=(TextView)findViewById(R.id.othershowOwnerProNameInlike);
        setProfileTitle.setTypeface(roboto);
        onBackAllPro=(ImageView)findViewById(R.id.onBackOtherProInLike);
        ...
        recycleOtherPostInProfile = (RecyclerView) findViewById(R.id.otherprofilePostRecycleInLike);
        ...
        showProPic.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(ShowProOfLCandS.this, ShowPostImage.class);
    ...
    private void showUserProfile() {
        userRef.child(currentUserIdss).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.child("profileLink").exists()){
                    userProLink = dataSnapshot.child("profileLink").getValue().toString();
                    Picasso.with(ShowProOfLCandS.this).load(userProLink).placeholder(R.drawable.profile).into(showProPic);
                }
        ...
        FirebaseRecyclerAdapter<AllPostModel, ShowPost.ViewHolder> firebaseRecyclerAdapter=new FirebaseRecyclerAdapter<AllPostModel, ShowPost.ViewHolder>
            ...
            protected void populateViewHolder(final ShowPost.ViewHolder viewHolder, final AllPostModel model, int position) {
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                if (shareButtonChecker.equals(true)){
                                    ...
                                    if (model.getPostType().equals("message")){
                                        Toast.makeText(ShowProOfLCandS.this, "Message Type Post Can't be shared", Toast.LENGTH_SHORT).show();
                                        shareButtonChecker=false;
                                    }
                ...
                viewHolder.setBottomState.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent=new Intent(ShowProOfLCandS.this, PostDetails.class);
                        intent.putExtra("postKey",postKey);
                        intent.putExtra("uidKey",currentUserIdss);
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                ...
                                if (bookmarkChecker.equals(true)){
                                    if (dataSnapshot.child(postKey).hasChild(currentUserInAllProfile)){
                                        ...
                                        String sendNotificationTo=currentUserIdss;
                ...
                viewHolder.showOption.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        final PopupMenu popupMenu=new PopupMenu(ShowProOfLCandS.this,viewHolder.showOption);
                            ...
                            public boolean onMenuItemClick(MenuItem item) {
                                switch (item.getItemId()){
                                    case R.id.viewProfile:
                                        Intent intent=new Intent(ShowProOfLCandS.this, ShowAlluserProfile.class);
                                        intent.putExtra("postKey",postKey);
                                        startActivity(intent);
                                        break;
                                    case R.id.deletePosts:
                                        final AlertDialog.Builder builder=new AlertDialog.Builder(ShowProOfLCandS.this);
                                    ...
                                    case R.id.verifyGiggleItPost:
                                        ...
                                        Toast.makeText(ShowProOfLCandS.this, "Post Verified as Giggle IT", Toast.LENGTH_SHORT).show();
                                        break;
                                }
                                return true;
                            }
    ...
    public Uri getLocalBitmapUri(Bitmap bmp) {
        ...
        try {
            ...
            out.close();
            bmpUri = FileProvider.getUriForFile(ShowProOfLCandS.this, BuildConfig.APPLICATION_ID + ".provider",file);
        } catch (IOException e) {
            e.printStackTrace();
        }
        return bmpUri;
